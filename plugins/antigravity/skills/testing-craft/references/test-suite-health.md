...
the number, not tests written to catch a bug. Apply that principle here
too, whatever the repository's own stated testing policy says, rather
than treating a coverage percentage as a goal in its own right.
