...
- **`docs/decisions/0007-...md`**, recording why `canon-mcp` still cannot learn its workspace on Antigravity and what the three options cost. The seam (`canon_mcp._git.set_client_root`) is in place so the choice is a one-call-site change.
